...
public class DragonSpawnMIEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DragonSpawnMIEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DragonSpawnMIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DragonSpawnMIIW/InitOutcome.xml").getDocumentElement();
